        ...
        <div class="card">
            ...
            <div class="card-body">
                <form v-on:submit.prevent="formulario">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="user" aria-describedby="helpId"
                                    id="pkPuesto" placeholder="Ingrese un ID" v-model="pkPuesto" />
                    ...
                    <br>
                    <div id="botoncerrar" style="display: none;">|<router-link :to="{name:'listarpuesto'}" type="button" class="btn btn-outline-primary">Volver</router-link>|</div>
...
export default {
    ...
    methods: {
        formulario() {
            ...
            axios.put('https://localhost:7289/Puesto?id=' + this.pkPuesto, cuerpo).then((result) => {
        ...
        Buscar(id) {
            if (id > 0) {
                axios.get('https://localhost:7289/Puesto?id=' + id).then((response) => {
