        ...
        <div class="card">
            ...
            <div class="card-body">
                <form v-on:submit.prevent="formulario">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="apellidos" id="apellidos"
                                        aria-describedby="helpId" placeholder="Ingrese un nuevo apellido" value="" />
                        ...
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="telefono" id="telefono"
                                    aria-describedby="helpId" placeholder="Ingrese un nuevo telefono" value="" />
                            </div>
                        </div>
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" name="email" id="email" aria-describedby="helpId"
                                    placeholder="Ingrese un nuevo email" value="" />
                            </div>
                        </div>
                        <div class="col">
                    ...
                    <br>
                    <div id="botoncerrar" style="display: none;">|<router-link :to="{name:'listarcliente'}" type="button" class="btn btn-outline-primary">Volver</router-link>|</div>
...
export default {
    ...
    methods: {
        formulario() {
            ...
            axios.put('https://localhost:7289/Cliente?id=' + this.pkCliente, cuerpo).then((result) => {
        ...
        Buscar(id) {
            if (id > 0) {
                axios.get('https://localhost:7289/Cliente?id=' + id).then((response) => {
                    ...
                    if (this.cliente != null) {
                        ...
                        document.getElementById('apellidos').value = this.cliente[0].apellidos;
