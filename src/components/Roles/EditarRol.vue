        ...
        <div class="card">
            ...
            <div class="card-body">
                <form v-on:submit.prevent="formulario">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="user" aria-describedby="helpId"
                                    id="pkRol" placeholder="Ingrese un ID" v-model="pkRol" />
                                ...
                                <div id="botonbusca">
                                    ...
                                    <router-link :to="{ name: 'listarrol' }" class="btn btn-outline-danger">Cancelar</router-link>
                                </div>
                            </div>
                        </div>
                    ...
                    <br>
                    <div id="botoncerrar" style="display: none;">|<router-link :to="{name:'listarrol'}" type="button" class="btn btn-outline-primary">Volver</router-link>|</div>
...
export default {
    ...
    methods: {
        formulario() {
            ...
            axios.put('https://localhost:7289/Rol?id=' + this.pkRol, cuerpo).then((result) => {
        ...
        Buscar(id) {
            if (id > 0) {
                axios.get('https://localhost:7289/Rol?id=' + id).then((response) => {
                    ...
                    if (this.rol != null) {
                        ...
                        document.getElementById('nombre').value = this.rol[0].nombre;
