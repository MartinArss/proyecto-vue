            ...
            <div class="card-body">
                <form v-on:submit.prevent="formulario">
                        ...
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nombre" aria-describedby="helpId" id="nombre"
                                    placeholder="Ingrese un nombre de rol" v-model="rol.nombre" />
                    ...
                    <div class="row">
                        ...
                        <router-link :to="{ name: 'listarrol' }" class="btn btn-outline-secundary" id="finaliza" style="display: none;">Regresar</router-link>
                    </div>
                    <br>
                    <div class="row">
...
export default {
    ...
    methods: {
        formulario() {
            ...
            axios.post('https://localhost:7289/Rol', cuerpo).then((result) => {

                if (result.status == 200) {
                    document.getElementById("alert").style.display = "block";
                    document.getElementById('botonesopcion').style.display="none";
                    this.smg = "El rol se agrego correctamente";
