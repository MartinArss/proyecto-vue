                ...
                <form v-on:submit.prevent="formulario">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="user" aria-describedby="helpId"
                                        id="user" placeholder="Ingrese un nuevo nombre de usuario" value="" />
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="password" id="password"
                                        aria-describedby="helpId" placeholder="Ingrese una nueva contraseña" value="" />
                                </div>
                    ...
                    <div id="fk-empleado-rol" class="row" style="display: none;">
                        ...
                        <!-- <div class="col">
                            ...
                            <div class="form-group">
                                <label for="direccion">Fecha regitro:</label>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="empleado">Cambio empleado:</label>
                                <!-- <input type="number" class="form-control" name="fkEmpleado" id="fkEmpleado"
                                    aria-describedby="helpId" placeholder="Ingrese un nuevo empleado" value="" /> -->
                                <select class="form-control" name="fkEmpleado" id="fkEmpleado"
                                    aria-describedby="helpId" placeholder="Ingrese nuevo empleado" value="">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="rol" >Cambio de rol:</label>
                                <select class="form-control" name="fkRol" id="fkRol"
                                    aria-describedby="helpId" placeholder="Ingrese nuevo rol" value="">
                    ...
                    <br>
                    <div id="botoncerrar" style="display: none;">|<router-link :to="{name:'listarusuario'}" type="button" class="btn btn-outline-primary">Volver</router-link>|</div>
...
export default {
    ...
    methods: {
        formulario() {
            ...
            axios.put('https://localhost:7289/Usuario?id=' + this.pkUsuario, cuerpo).then((result) => {
        ...
        Buscar(id) {
            if (id > 0) {
                axios.get('https://localhost:7289/Usuario?id=' + id).then((response) => {

                    this.usuario = response.data.result
                    if (this.usuario == null) {
                        ...
                        document.getElementById('user').value = this.usuario[0].user;
                        document.getElementById('password').value = this.usuario[0].password;
                        document.getElementById('fkEmpleado').value = this.usuario[0].fkEmpleado;
                        document.getElementById('fkRol').value = this.usuario[0].fkRol;
